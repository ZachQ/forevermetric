...
public class DistanceGame {
	...
	DistanceGame(String landmarkLocation) {
		...
		if(landmarkLocation.compareTo("USA") == 0 || landmarkLocation.compareTo("All") == 0) {
			DistanceGameObject tempObject = new DistanceGameObject("How many kilometers are you from The Ohio Stadium?", Measurement.KILOMETER, 40.001667, -83.019722);
			...
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from The Ohio Stadium?", Measurement.MILE, 40.001667, -83.019722);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from The Empire State Building?", Measurement.MILE, 40.748433, -73.985656);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from Mount Rushmore?", Measurement.MILE, 43.878947, -103.459825);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from the Space Needle?", Measurement.MILE, 47.6204, -122.3491);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from Niagara Falls?", Measurement.MILE, 43.08, -79.071);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from The White House?", Measurement.MILE, 38.897669, -77.03655);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from The Liberty Bell?", Measurement.MILE, 39.949486, -75.150294);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from The Golden Gate bridge", Measurement.MILE, 37.819722, -122.478611);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from The Statue of Liberty", Measurement.MILE, 40.689167, -74.044444);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from Hoover Dam", Measurement.MILE, 36.015556, -114.737778);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from The Gateway Arch", Measurement.MILE, 38.62452, -90.18471);
			objectsList.add(tempObject);
			...
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from The Eiffel Tower?", Measurement.MILE, 48.8583, 2.2945);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from The Colosseum?", Measurement.MILE, 41.890169, 12.492269);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from Big Ben?", Measurement.MILE, 51.500611, -0.124611);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from The Leaning Tower of Pisa?", Measurement.MILE, 43.722944, 10.396611);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from The Pantheon?", Measurement.MILE, 37.971421, 23.726166);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from Stonehenge?", Measurement.MILE, 51.178844, -1.826189);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from Buckingham Palace?", Measurement.MILE, 51.501, -0.142);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from Windsor Castle", Measurement.MILE, 51.483889, -0.604444);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from The Sistine Chapel?", Measurement.MILE, 41.903056, 12.454444);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from The Grand Canal in Venice?", Measurement.MILE, 45.436667, 12.333056);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from Neuschwanstein Castle?", Measurement.MILE, 47.5575, 10.75);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from Pompeii?", Measurement.MILE, 40.751, 14.487);
			objectsList.add(tempObject);
			...
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from The Taj Mahal?", Measurement.MILE, 27.174167, 78.042222);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from Angkor Wat?", Measurement.MILE, 13.4125, 103.866667);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from The Forbidden City?", Measurement.MILE, 39.914722, 116.390556);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from The Temple of Heaven?", Measurement.MILE, 39.882242, 116.406469);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from Potala Palace?", Measurement.MILE, 29.657778, 91.116944);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from Mount Tai?", Measurement.MILE, 36.255833, 117.1075);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from Burj Khalifa?", Measurement.MILE, 25.197139, 55.274111);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from Mount Fuji?", Measurement.MILE, 35.358, 138.731);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from The Petronas Towers?", Measurement.MILE, 3.15785, 101.71165);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from Bangkok?", Measurement.MILE, 13.752222, 100.493889);
			objectsList.add(tempObject);
			tempObject = new DistanceGameObject("How many miles are you from beijing?", Measurement.MILE, 39.913889, 116.391667);
			objectsList.add(tempObject);
		}
	}
